let ARCH = function (m) {
	 ...
	 * @return {boolean}
	 */
	m.DefenceArmy = function (gameState, foeEntities, type) {
	 ...
	 */
	m.DefenceArmy.prototype.addFoe = function (gameState, enemyId, force) {
	 ...
	 */
	m.DefenceArmy.prototype.removeFoe = function (gameState, enemyId, enemyEntity) {
	 ...
	 */
	m.DefenceArmy.prototype.addOwn = function (gameState, id, force) {
	...
	m.DefenceArmy.prototype.removeOwn = function (gameState, id, Entity) {
	 ...
	 */
	m.DefenceArmy.prototype.clear = function (gameState) {
	...
	m.DefenceArmy.prototype.assignUnit = function (gameState, entID) {
	...
	m.DefenceArmy.prototype.getType = function () {
		return this.type;
	};

	m.DefenceArmy.prototype.getState = function () {
	 ...
	 */
	m.DefenceArmy.prototype.merge = function (gameState, otherArmy) {
	...
	m.DefenceArmy.prototype.needsDefenders = function (gameState) {
		let defenceRatio;
	...
	m.DefenceArmy.prototype.recalculatePosition = function (gameState, force) {
	...
	m.DefenceArmy.prototype.recalculateStrengths = function (gameState) {
		this.ownStrength = 0;
		this.foeStrength = 0;
	...
	m.DefenceArmy.prototype.evaluateStrength = function (ent, isOwn, remove) {
		if (!ent)
			return;
	...
	m.DefenceArmy.prototype.checkEvents = function (gameState, events) {
	...
	m.DefenceArmy.prototype.update = function (gameState) {
		for (let entId of this.ownEntities) {
			let ent = gameState.getEntityById(entId);
			if (!ent)
				continue;
...
///
	m.DefenceArmy.prototype.Serialize = function () {
		return {
			"ID": this.ID,
			"type": this.type,
	...
	m.DefenceArmy.prototype.Deserialize = function (data) {
		for (let key in data)
			this[key] = data[key];
	};
///
