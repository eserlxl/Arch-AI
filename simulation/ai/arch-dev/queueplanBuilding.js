let ARCH = function (m) {
	...
	m.ConstructionPlan = function (gameState, typeName, type, metadata, position) {
...
/// DEBUG
	 ...
	 */
	m.ConstructionPlan.prototype.findDockPosition = function (gameState, maxWater = 16) {
		let template = this.template;
	 ...
	 */
	m.ConstructionPlan.prototype.buildOverseaDock = function (gameState, template, pos = false) {
