ARCH.launchAttackMessages = {
	...
	"check": [
		markForTranslation("I am starting a military campaign against %(_player_)s, come and join me."),
		markForTranslation("I have set up a large army to crush %(_player_)s. Join me and you will have your share of the loot.")
	],
	"other": [
...
ARCH.answerRequestAttackMessages = {
	"join": [
...
ARCH.answerDiplomacyRequestMessages = {
	"ally": {
		"decline": [
...
ARCH.sendDiplomacyRequestMessages = {
	"ally": {
		"sendRequest": [
...
ARCH.chatLaunchAttack = function (gameState, player, type) {
	Engine.PostCommand(PlayerID, {
		"type": "aichat",
		"message": "/allies " + pickRandom(this.launchAttackMessages[type === "Mate" ? "mate" : ("Check" ? "check" : "other")]),
...
ARCH.chatAnswerRequestAttack = function (gameState, player, answer, other) {
	Engine.PostCommand(PlayerID, {
		"type": "aichat",
...
ARCH.chatSentTribute = function (gameState, player) {
	Engine.PostCommand(PlayerID, {
		"type": "aichat",
...
ARCH.chatRequestTribute = function (gameState, resource) {
	Engine.PostCommand(PlayerID, {
		"type": "aichat",
...
ARCH.chatNewTradeRoute = function (gameState, player) {
	Engine.PostCommand(PlayerID, {
		"type": "aichat",
...
ARCH.chatNewPhase = function (gameState, phase, status) {
	Engine.PostCommand(PlayerID, {
		"type": "aichat",
...
ARCH.chatNewDiplomacy = function (gameState, player, newDiplomaticStance) {
	Engine.PostCommand(PlayerID, {
		"type": "aichat",
...
ARCH.chatAnswerRequestDiplomacy = function (gameState, player, requestType, response, requiredTribute) {
	Engine.PostCommand(PlayerID, {
		"type": "aichat",
...
ARCH.chatNewRequestDiplomacy = function (gameState, player, requestType, status) {
	Engine.PostCommand(PlayerID, {
		"type": "aichat",
		"message": "/msg " + gameState.sharedScript.playersData[player].name + " " +
