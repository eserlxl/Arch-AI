let ARCH = function (m) {
	...
	m.ResourceManager = function (Config) {
		this.Config = Config;
	...
	m.ResourceManager.prototype.update = function (gameState, queues) {
...
/// DEBUG
	...
	m.ResourceManager.prototype.scarcity = function (required) {
		if (this.resource) {
	...
	m.ResourceManager.prototype.findJob = function (gameState, ent) {
	...
	m.ResourceManager.prototype.checkWorkers = function (gameState) {
		this.idleVillagers = 0;
		this.idleInfantry = 0;
		this.idleWorkers = 0;
		this.mainWorkers = 0;
	...
	m.ResourceManager.prototype.corral = function (gameState, queues) {
...
/// DEBUG
				...
				if (size > 0) {
					queues.corral.addPlan(new m.TrainingPlan(gameState, bestOption, {"trainer": corral.id()}, size, size));
					break;
				}
			}
		}
	...
	m.ResourceManager.prototype.field = function (gameState) {
		if (this.resource["food"] > 250 * this.currentPhase) {
			...
			this.fieldRequired = m.limit(this.fieldRequired, 0, this.Config.Economy.maxFieldCount);
...
///
	m.ResourceManager.prototype.Serialize = function () {
	};

	m.ResourceManager.prototype.Deserialize = function (data) {
		for (let key in data)
			this[key] = data[key];
	};
///
