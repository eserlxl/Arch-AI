...
let ARCH = (function () {
	...
	m.ArchBot = function ArchBot(settings) {
	...
	m.ArchBot.prototype = new API3.BaseAI();


	m.ArchBot.prototype.CustomInit = function (gameState) {
		///
	...
	m.ArchBot.prototype.OnUpdate = function (sharedScript) {
...
///
	...
	///
	m.ArchBot.prototype.Serialize = function () {
		let savedEvents = {};
		for (let key in this.savedEvents) {
	...
	m.ArchBot.prototype.Deserialize = function (data, sharedScript) {
